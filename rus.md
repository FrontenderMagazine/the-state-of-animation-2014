...
## Может быть Flash и ушёл, но эра веб-анимации только начинается

Со времён распространённости Flash, стало модным думать об анимации как о нечто
...
рекламного текста на экране, анимация всё ещё остаётся нам хорошим другом.
...
анимации, связующей все кусочки вместе. Если мы хотим перенести всё это в
Интернет, мы всё ещё нуждаемся в анимации.
...
Но всё может обернуться другой стороной. Команда Safari под iOS протолкнула
...
создавать. Клиенты, которые за всё платят, требуют надёжной поддержки анимации в
распространённых браузерах; так, многие из разработчиков интерактива и их
...
*  позволяет (определённой) анимации выполняться в собственном потоке, освобождая
от лишнего;
...
полифил всё ещё будет менее производительным, нежели GSAP, абсолютный чемпион
...
прогнать всё используя WebGL непосредственно в GPU (как некоторые доморощенные
...
- [Rachel Nabors][41], глава мозгового центра анимации в [Tin Magpie][42]
 ...
 [Отображение анимации с учётом состояний]: img/02-stateful-animation-opt.png
