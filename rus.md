...
опубликованы, потому что у людей и агентств, создающих их, нет времени,
...
написанных на JavaScript. Таким образом, этот полифил не то, что разработчики
...
- [Брайан Бёртлс][37], главный автор спецификации из Mozilla Japan
